...
Partial Class _Default
    ...
    Dim conn As New SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\polai\Documents\Visual Studio 2010\WebSites\WebSite2\App_Data\Database.mdf;Integrated Security=True;User Instance=True")
